...
samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.o: ../samples/cpp/tutorial_code/viz/launching_viz.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/cfreeze/opencv/opencv-3.4.9/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.o"
	cd /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.o -c /home/cfreeze/opencv/opencv-3.4.9/samples/cpp/tutorial_code/viz/launching_viz.cpp
...
samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.i: cmake_force
	...
	cd /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/cfreeze/opencv/opencv-3.4.9/samples/cpp/tutorial_code/viz/launching_viz.cpp > CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.i
...
samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.s: cmake_force
	...
	cd /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/cfreeze/opencv/opencv-3.4.9/samples/cpp/tutorial_code/viz/launching_viz.cpp -o CMakeFiles/example_tutorial_launching_viz.dir/tutorial_code/viz/launching_viz.cpp.s
...
bin/example_tutorial_launching_viz: lib/libopencv_stitching.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_superres.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_videostab.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_aruco.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_bgsegm.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_bioinspired.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_ccalib.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_dnn_objdetect.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_dpm.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_face.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_freetype.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_fuzzy.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_hdf.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_hfs.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_img_hash.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_line_descriptor.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_optflow.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_reg.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_rgbd.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_saliency.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_stereo.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_structured_light.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_surface_matching.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_tracking.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_xfeatures2d.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_ximgproc.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_xobjdetect.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_xphoto.so.3.4.9
...
bin/example_tutorial_launching_viz: lib/libopencv_shape.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_highgui.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_videoio.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_viz.so.3.4.9
...
bin/example_tutorial_launching_viz: lib/libopencv_phase_unwrapping.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_video.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_datasets.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_plot.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_text.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_ml.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_dnn.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_imgcodecs.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_objdetect.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_calib3d.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_features2d.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_flann.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_photo.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_imgproc.so.3.4.9
bin/example_tutorial_launching_viz: lib/libopencv_core.so.3.4.9
bin/example_tutorial_launching_viz: samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/cfreeze/opencv/opencv-3.4.9/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tutorial_launching_viz"
	cd /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tutorial_launching_viz.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/clean:
	cd /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_tutorial_launching_viz.dir/cmake_clean.cmake
...
samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/depend:
	cd /home/cfreeze/opencv/opencv-3.4.9/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/cfreeze/opencv/opencv-3.4.9 /home/cfreeze/opencv/opencv-3.4.9/samples/cpp /home/cfreeze/opencv/opencv-3.4.9/build /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp /home/cfreeze/opencv/opencv-3.4.9/build/samples/cpp/CMakeFiles/example_tutorial_launching_viz.dir/DependInfo.cmake --color=$(COLOR)
